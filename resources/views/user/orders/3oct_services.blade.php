...
" >
    <div class="card border-0" style="background-color: #53b5c5!important;height: 100%;">
      <div class="card-body pt-2">
        <!-- BOX CONTENT -->
       <div class="box-content" style="color: #ffffff;width: 74%;left: 10%;margin-left: 11%;">
          <form id="submit-order" method="post" enctype="multipart/form-data">
            ...
            <div class="row" id="step1">
              ...
              <div class="col-md-12 mt-2">
				...
				<input type="hidden" id="fo" value="{{$checkOrder}}">
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="work_level_id" class="form-control" id="f-wl" required style="height:50px">
                    <option value="" disabled selected>Your Academic Level</option>
              ...
              <div class="col-md-5 mt-2">
                <div class="form-group">
                  ...
                  <div class="d-flex">
                    ...
                    <input type="number" name="qty" class="text-center no-arrows" id="quantity" value="1" min="1"  style="width:100%;/* border:none; */border: 1px solid #ced4da;">
            ...
            <div class="row" style="display: none;" id="step2">
              ...
              <!-- Step 2 Form Fields -->
              <div class="col-md-12 mt-2"style="margin-top: 11%!important;">
                <div class="form-group">
              ...
              <div class="col-md-12 mt-2">
                ...
                <div class="form-group">
                  ...
                  <select name="timezones2" id="timezone" class="form-control" required>
				  ...
				  <div class="col-md-12 mt-2" id="otherTimeZone" style="display: none;">
                <div class="form-group">
                  <label for="f-other-style">Enter Time Zone</label>
                  <input type="text" name="timezones" id="f-timezones" class="form-control" placeholder="Enter Time Zone">
                </div>
              </div>
				  
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  <label for="f-specifications">Order Description</label>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      ...
                      <input type="file" name="file[]" class="custom-file-input" id="file" multiple style="color:white!important;">
                    </div>
                  </div>
                </div>
...
@endforeach
    ...
    color: white!important;">Review Order Details</h4>
              </div>
              <!-- Step 3 Form Fields -->
              <div class=" ">

                <h3 class="page-title"style="
    color: white!important;">Personal Information</h3>
                <p style="
    color: white!important;">Name<span class="float-right" style="
    ...
    color: white!important; float: right;">
                ...
                <br>
                <h3 class="page-title"  style="
    color: white!important;">Order Details</h3>
    <table class="table">
...
">
    ...
    <td><span class="float-right" id="btitle" style="
   color: white!important; float: right;"> </span></td>
    </tr>
...
"> <p style="color:white!important;">
     ...
     <td><span class="float-right" style="
   color: white!important; float: right; " >
           <i class="fa {{format_amount(1)['icon']}}" style="
   color: white!important; "></i>
           <span id="btotal" style="
   color: white!important; "></span>
         </span></td>
     </tr>
    <tr>
       <td style="
...
">
     ...
     <td>    <span class="float-right" id="bservice" style="
   color: white!important; float: right;"> </span></td>
    </tr>
    <tr>
...
"><p style="color:white!important;">
     Education Level
      ...
      <td>   <span class="float-right" id="bwork_level" style="
   color: white!important; float: right!important;"> </span></td>
     </tr>
    <tr>
   ...
   width: 40%;
">
    <p style="color:white!important;width: 98px;">
     Educational Level
   
     </p></td>
      <td>
     <span class="float-right"   id="bwork_level" style="float:right!important;color:white!important;"> {{$wl->name}}</span>
           </p>
...
"> <p style="color:white!important;width: 98px;">
     Writer’s Level
      ...
      <td> <span class="float-right" id="bplan_type" style="
   color: white!important; float: right; float: right; float: right;"> </span></td>
     </tr>
...
"><p style="color:white!important;">
     ...
     <td>  <span class="float-right" style="
   color: white!important; float: right; float: right;"> <span id="bqty" style="
   color: white!important; float: right;"></span> Pages</span></td>
     </tr>
...
"> <p style="color:white!important;">
   ...
   <td><span class="float-right" id="bformatting" style="
   color: white!important; float: right;"> </span></td>
     </tr>
...
"><p style="color:white!important;">
      ...
      <td><span class="float-right" id="bcourse" style="
   color: white!important; float: right;"> </span></td>
     </tr>
...
"> <p style="color:white!important;">
      ...
      <td>  <span class="float-right" id="bsources" style="
   color: white!important; float: right;"> </span></td>
     </tr>
...
">
    ...
    <td>   <span class="float-right" id="bposted" style="
   color: white!important; float: right;"> </span>
...
">
    ...
    <td> <span class="float-right" id="bdeadline_date" style="
   color: white!important; float: right;"> </span>
...
">
    ...
    <td> 	 <span class="float-right mr-2" id="file_name" style="
   color: white!important; float: right;"></span>
            ...
            <div class="row">
              <div class="col-md-12 mt-2"style="margin-top: 11%!important;">
                <div class="form-group">
                  ...
                  <a class="btn btn-primary p-2 float-right" id="next" style="float:right!important">Next</a>
                  <button style="display:none;float: right!important;" class="btn btn-primary p-2 float-right" id="placeOrder">Place Order</button>
                </div>
              </div>
            </div>
          </form>
  ...
  <div class="card border-0" style="background-color: #53b5c5">
          ...
          <div class="col-md-12 col-sm-12 pr-4">
            ...
            <div class="divider mb-4">
              <div class="divider-text text-muted" style="color: #ffffff !important;">
				...
				@if($checkOrder == 0)
				  <p class="text-dark"> Welcome To MPW <br> First "3 pages" Order is Free! </P>
			  @endif
            </div>

          <div style="color:white!important;">
              <p class="fs-12 p-family">{{ __('Subtotal') }} <span class="checkout-cost"> <i class="fa {{format_amount(1)['icon']}}"></i><span id="sub_total">
				  @if($checkOrder > 0)
				  {{format_amount(6.99)['amount']}}
				  @else
				  0
				  @endif</span></span></p>
<h2 id="congoMsg" style="display:none">Congratulations<br>
					<span style="font-size:17px">Your Free Order has been placed</span>
				</h2>
            </div>
<div id="checkouts" style="display:none">
            ...
            <div id="voucher-result" class="d-none">
              <p class="fs-12 p-family" style="color:white!important">{{ __('Discount Applied') }} <span class="checkout-cost"> <i class="fa {{format_amount(1)['icon']}}"></i> <span id="total_discount"></span></span></p>
            </div>

            <div>
              <p class="fs-12 p-family"style="color:white!important;">{{ __('Total Payment') }} <span class="checkout-cost"style="color:white!important"style="color:white!important;"> <i class="fa {{format_amount(1)['icon']}}"style="color:white!important"></i> <span class="text-info" id="gtotal" style="color:white!important;">0</span></span></p>
            </div>
...
<hr>
<img  src="{{asset('img/users/stripe.jpg')}}" >
    </div>
  </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px; border-radius: 0.5rem;">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
            <div class="card border-0" style="background-color: #44afc3;color: #ffffff;height: 92%;">
                <div class="card-body">
                  <h5 class="card-title">Payment Method</h5>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="paymentOption" id="stripeOption" value="stripe" checked>
                    <label class="form-check-label" for="stripeOption" style="color:white!important">
                  ...
                  <form id="stripe-form" style="display: block;">
                    <div class="mb-3">
						<input type="hidden" class="datetimee" name="dt">
            ...
            <div class="col-md-6">
              <!-- Payment Summary -->
              <div class="card border-0"  style="background-color: #44afc3; color: #ffffff;">
                <div class="card-body">
                  ...
                  <div class="card-text">
                    ...
                    <p class="fs-12 p-family" style="color: #ffffff;">Total Payment: <span class="checkout-cost" style="color:white"><i class="fa {{format_amount(1)['icon']}}"></i><span class="text-info" id="gtotal2" style="color:white!important">0</span></span></p>
                  </div>
                  <br>
...
<div class="modal mt-5 fade" id="exModal" tabindex="-1" aria-labelledby="exModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exModalLabel">Congratulations</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
		  <h5> Your Free Order has been placed</h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary p-1" data-bs-dismiss="modal">OK</button
      </div>
    </div>
  </div>
</div></div>
...
<script>
    ...
    document.getElementById('timezone').addEventListener('change', function() {
      var otherStyleField = document.getElementById('otherTimeZone');
      if (this.value === 'Other') {
  ...
  <script>
    $(document).ready(function() {
		...
		console.log('Time is '+formattedDateTime);
