          ...
          <form id="update-order" method="post" enctype="multipart/form-data">
            ...
            <div class="row" style="display: none;" id="step3">
              ...
              <div class=" ">
                ...
                <h3 class="page-title" style="color: black;">Personal Information</h3>
                <p style="color: black;">Name<span style="color: black;" class="float-right">
                ...
                <br>
                <h3 style="color: black;" class="page-title">Order Details</h3>
                <p style="color: black;">
                  Title
                  <span class="float-right" id="btitle" style="color: black;"> </span>
                </p>

                <p style="color: black;">
                  Amount
                  <span class="float-right" style="color: black;"><i style="color: black;" class="fa {{format_amount(1)['icon']}}"></i><span id="btotal"></span> </span>
                </p>
                <p style="color: black;">
                  Service Type
                  <span class="float-right" id="bservice"style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Education Level
                  <span class="float-right" id="bwork_level"style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Writer Level
                  <span class="float-right" id="bplan_type"style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Quantity
                  <span class="float-right"style="color: black;"> <span id="bqty" style="color: black;"></span> Pages</span>
                </p>
                <p style="color: black;">
                  Instruction
                  <span class="float-right" id="binstruction" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Citation
                  <span class="float-right" id="bformatting" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Course
                  <span class="float-right" id="bcourse" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Sources
                  <span class="float-right" id="bsources" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Posted On
                  <span class="float-right" id="bposted" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Deadline Date
                  <span class="float-right" id="bdeadline_date" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  Deadline Time
                  <span class="float-right" id="bdeadline_time" style="color: black;"> </span>
                </p>
                <p style="color: black;">
                  My File
                  <span class="float-right mr-2" id="file_name" style="color: black;"></span>
                </p>
...
<div id="checkouts" style="display:none">
            ...
            <a class="btn btn-primary" id="checkout" style="width: 100%;" >Checkout</a> 
            <br>
            <div class="divider mb-4">
              <div class="divider-text text-muted" style="color: #ffffff !important;">
...
<hr>
<img  src="https://quirky-turing.82-165-205-78.plesk.page/public/img/users/Screenshot%202023-09-21%20172222.png" >
      </div>
      ...
      <div class="modal-content" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px; border-radius: 0.5rem;">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <!-- Payment Summary -->
              <div class="card border-0" style="background-color: white; color:black;">
                <div class="card-body">
          ...
          bool = false;
            ...
            success: function(response) {
              if (response.status == 200) {
				...
				$('#checkouts').show();
				   $('#checkout').attr("href", "{{route('user.checkout')}}?order_id="+response.o_id)
                o = response.total;
