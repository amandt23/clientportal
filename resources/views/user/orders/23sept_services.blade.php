          ...
          <form id="submit-order" method="post" enctype="multipart/form-data">
            ...
            <div class="row" id="step1">
              ...
              <input type="hidden" id="pp" value="{{format_amount(6.99)['amount']}}">
				...
				<input type="hidden" id="datetimee" name="datetimee">
			...
			<div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="timezones" id="timezones" class="form-control" required>
					</select>
                </div>
              </div>
              <div class="col-md-12 mt-2">
          ...
          <div class="col-md-12 col-sm-12 pr-4">
            ...
            <div class="divider mb-4">
              <div class="divider-text text-muted" style="color: #ffffff !important;">
				...
				@if($checkOrder == 0)
				  <p> Welcome To MPW <br> First "3 pages" Order is Free! </P>
			  @endif
            </div>

            <div>
              <p class="fs-12 p-family" id="subs">{{ __('Subtotal') }} <span class="checkout-cost"> <i class="fa {{format_amount(1)['icon']}}"></i><span id="sub_total">0</span></span></p>
...
<script>
        // Function to populate the time zones
        function populateTimeZones() {
            const timezones = Intl.DateTimeFormat().resolvedOptions().timeZone;
            const timezoneSelect = document.getElementById('timezones');
            const allTimezones = moment.tz.names(); // Requires moment.js and moment-timezone.js
            ...
            timezoneSelect.value = timezones; // Set default value to user's current timezone
        }

        // Call the function to populate time zones
        populateTimeZones();
    </script>
