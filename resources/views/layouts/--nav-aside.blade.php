...
<li class="slide">
   ...
   <span class="badge badge-warning ml-3">{{ auth()->user()->unreadNotifications->where('type', 'App\Notifications\GeneralNotification')->count() }}</span>
    ...
    <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
        ...
        <ul class="slide-menu">
            <li><a href="{{ route('admin.user.admin') }}" class="slide-item">{{ __('Super Admin') }}</a></li>
            <li><a href="{{ route('admin.user.list') }}" class="slide-item">{{ __('Client List') }}</a></li>
            <li><a href="#" class="slide-item">{{ __('Support Dept') }}</a></li> 
			<li><a href="{{ route('admin.managers') }}" class="slide-item">{{ __('Manager List') }}</a></li> 
			<li><a href="{{ route('admin.executives') }}" class="slide-item">{{ __('Executive List') }}</a></li><li > 
			<li><a href="#" class="slide-item">{{ __('Writers Dept') }}</a></li><li > 
			<li><a href="{{ route('admin.managers') }}" class="slide-item">{{ __('Manager List') }}</a></li>
			<li><a href="{{ route('admin.writers') }}" class="slide-item">{{ __('Writer List') }}</a></li>
            <li><a href="{{ route('admin.proofreaders') }}" class="slide-item">{{ __('Proofreader List') }}</a></li> 
			<li><a href="{{ route('admin.supervisors') }}" class="slide-item">{{ __('Supervisor List') }}</a></li><li > 
				<li><a href="{{ route('admin.trainers') }}" class="slide-item">{{ __('Trainer List') }}</a></li><li > 
