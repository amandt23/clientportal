    ...
    <div class="container-fluid"> 
        ...
        <div class="d-flex">
            ...
            <a class="header-brand" href="{{ url('/') }}">
				<p style="float:right;color:white;font-weight: bold;"> Fred</p>
...
">
										...
										?>
                                           ...
                                           @if ($notification->type == 'new-user') 
										        ...
										        @if ($notification->type == 'order-placed')                                                
                                                    <div>
                                                        <a href="{{ route('admin.order_details') }}?id=6" class="d-flex">
                                                            <div class="notifyimg bg-info-green"> <i class="fa-solid fa-face-tongue-money fs-20 leading-loose"></i></div>
                                                            <div class="mr-4">
    ...
    margin-top: 10px;
">
                   <a class="nav-link icon" data-bs-toggle="dropdown" style="
    margin-top: 6%;
">
                ...
                <div class="dropdown profile-dropdown">
					...
					<p style="float:right; color:white;"> {{ auth()->user()->username }}</p>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
