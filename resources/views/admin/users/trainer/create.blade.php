...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Create New Trainer') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('New Trainer') }}</a></li>
		...
		<div class="col-xl-9 col-lg-8 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create New Trainer') }}</h3>
				</div>
				<div class="card-body pb-0">
					<form method="POST" action="{{ route('admin.trainer_store') }}" enctype="multipart/form-data">
						@csrf
						...
						<div class="col-sm-6 col-md-6">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="role" value="trainer" readOnly>
