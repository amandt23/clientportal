...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Create New Executive') }}</h4>
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fa-solid fa-user-shield mr-2 fs-12"></i>{{ __('Admin') }}</a></li>
				
				<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.managers') }}"> {{ __('Executive List') }}</a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('New Executive') }}</a></li>
		...
		<div class="col-xl-9 col-lg-8 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create New Admin') }}</h3>
				</div>
				<div class="card-body pb-0">
					<form method="POST" action="{{ route('admin.executive_store') }}" enctype="multipart/form-data">
						@csrf
						...
						<div class="col-sm-6 col-md-6">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="role" value="executive" readOnly>
