...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Create New Supervisor') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('New Supervisor') }}</a></li>
		...
		<div class="col-xl-9 col-lg-8 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create New Supervisor') }}</h3>
				</div>
				<div class="card-body pb-0">
					<form method="POST" action="{{ route('admin.user.storeAdmin') }}" enctype="multipart/form-data">
						@csrf
						...
						<div class="card-footer border-0 text-right mb-2 pr-0">
							<a href="{{ route('admin.supervisors') }}" class="btn btn-cancel mr-2">{{ __('Return') }}</a>
