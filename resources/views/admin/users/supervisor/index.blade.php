...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Supervisor List') }}</h4>
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fa-solid fa-id-badge mr-2 fs-12"></i>{{ __('Admin') }}</a></li>
							<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.user.list') }}">{{ __('Supervisor List') }}</a></li>
				
			</ol>
		</div>
			<div class="page-rightheader">
			<a href="{{ route('admin.supervisor_create') }}" class="btn btn-primary mt-1">{{ __('Create New Supervisor') }}</a>
		</div>
	</div>
	<!-- END PAGE HEADER -->
@endsection
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Supervisor Management') }}</h3>
				</div>
