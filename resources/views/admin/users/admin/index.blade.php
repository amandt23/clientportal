...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Admin User') }}</h4>
			...
			<a href="{{ route('admin.user.createAdmin') }}" class="btn btn-primary mt-1">{{ __('Create New Admin') }}</a>
		</div>
	</div>
	<!-- END PAGE HEADER -->
@endsection
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Admin Management') }}</h3>
				</div>
