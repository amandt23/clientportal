...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Writer List') }}</h4>
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fa-solid fa-id-badge mr-2 fs-12"></i>{{ __('Admin') }}</a></li>
							<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.user.list') }}">{{ __('Writer List') }}</a></li>
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Writer Management') }}</h3>
				</div>
				<div class="card-body pt-2">
					...
					<div class="box-content">
						...
						<!-- DATATABLE -->
						<table id='listUsersTable' class='table' width='100%'>
								<thead>
									<tr>	
...
@section('js')
	...
	<script type="text/javascript">
		$(function () {
			...
			"use strict";
			    if ($.fn.DataTable.isDataTable('#listUsersTable')) {
