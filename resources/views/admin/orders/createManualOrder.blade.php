...
<div class="row">
	<div class="col-xl-12 col-lg-12 col-sm-12">
		<div class="card border-0">
			...
			<div class="card-body pb-0 p-3 rounded"  style="background-color: white; color: #ffffff;">
				<form method="POST" class="row" action="{{ route('admin.storeManualOrder') }}" enctype="multipart/form-data">
            ...
            @csrf
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
					...
					<input type="text" name="service_id" class="form-control" placeholder="Enter Service" required>
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
					...
					<input type="text" name="work_level_id" class="form-control" placeholder="Enter Education Level" required>
   ...
   <div class="col-md-12 mt-2">
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  <label for="f-formatting">Citation Style</label>
					<input type="text" name="formatting2" class="form-control" placeholder="Enter citation style" required>
			...
			<button class="btn btn-primary btn-block" style="margin-top:3%!important">Submit</button>
