...
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">{{ __('Completed Manual Orders') }}</h4>
        <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}"><i class="fa-solid fa-id-badge mr-2 fs-12"></i>{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item" aria-current="page">{{ __('Completed Manual Orders List') }}</li>
        </ol>
    </div>
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#listUsersTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "{{ route('admin.completedManualOrders') }}",
				columns: [
					{
						data: 'title',
						name: 'title',
